  ...
  <ul>
      ...
      <li>
        ...
        <a href="./login.php">登入</a>
         ...
         <div class="section">
          <h1>管理文章</h1>
<a class="admin_add" href="./add.php">新增文章</a> <a class="admin_manage" href="./admin_category.php">管理分類</a>
          <ul>
          <?php
          ...
          if ($result->num_rows > 0){
            while($row = $result->fetch_assoc()){
              ...
              echo "<a class='admin_update' href='update.php?id=$row[id]'>update</a>";
              echo "<a class='admin_delete' href='delete.php?id=$row[id]'>delete</a>";
              echo "</li>";
            }
          }
          ?>
